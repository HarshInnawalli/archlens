...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"setting-maxmemory-for-a-replicated-or-persisted-instance","title":"Setting maxmemory for a replicated or persisted instance"}],"id":"maxmem","title":"Using the maxmemory configuration directive"},{"children":[{"id":"using-the-info-command","title":"Using the INFO command"}],"id":"eviction-policies","title":"Eviction policies"},{"id":"apx-lru","title":"Approximated LRU algorithm"},{"id":"lfu-eviction","title":"LFU eviction"},{"id":"lrm-eviction","title":"LRM eviction"}]}
...
You can also use [`CONFIG SET`](https://redis.io/docs/latest/commands/config-set) to
set `maxmemory` at runtime using [`redis-cli`](https://redis.io/docs/latest/develop/tools/cli):
...
If you are using
[replication](https://redis.io/docs/latest/operate/rs/databases/durability-ha/replication)
or [persistence](https://redis.io/docs/latest/operate/rs/databases/configure/database-persistence)
...
The [`INFO`](https://redis.io/docs/latest/commands/info) command returns a
...
The [`INFO`](https://redis.io/docs/latest/commands/info) command provides several pieces
...
> [!NOTE]
>  When the [`EXISTS`](https://redis.io/docs/latest/commands/exists)
...
See these pages for information on eviction policies in: (1) [Redis Software](https://redis.io/docs/latest/operate/rs/databases/memory-performance/eviction-policy) and (2) [Redis Cloud](https://redis.io/docs/latest/operate/rc/databases/configuration/data-eviction-policies).
