...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"rdb-advantages","title":"RDB advantages"},{"id":"rdb-disadvantages","title":"RDB disadvantages"},{"id":"aof-advantages","title":"AOF advantages"},{"id":"aof-disadvantages","title":"AOF disadvantages"},{"children":[{"id":"how-it-works","title":"How it works"}],"id":"snapshotting","title":"Snapshotting"},{"children":[{"id":"log-rewriting","title":"Log rewriting"},{"id":"how-durable-is-the-append-only-file","title":"How durable is the append only file?"},{"id":"what-should-i-do-if-my-aof-gets-truncated","title":"What should I do if my AOF gets truncated?"},{"id":"what-should-i-do-if-my-aof-gets-corrupted","title":"What should I do if my AOF gets corrupted?"},{"id":"how-it-works-1","title":"How it works"},{"id":"how-i-can-switch-to-aof-if-im-currently-using-dumprdb-snapshots","title":"How I can switch to AOF, if I'm currently using dump.rdb snapshots?"}],"id":"append-only-file","title":"Append-only file"},{"id":"interactions-between-aof-and-rdb-persistence","title":"Interactions between AOF and RDB persistence"},{"children":[{"id":"backing-up-aof-persistence","title":"Backing up AOF persistence"},{"id":"online-backups-with-the-backup-command-family","title":"Online backups with the BACKUP command family"}],"id":"backing-up-redis-data","title":"Backing up Redis data"},{"id":"disaster-recovery","title":"Disaster recovery"}]}
...
If you'd rather not think about the tradeoffs between these different persistence strategies, you may want to consider [Redis Software's persistence options](https://redis.io/docs/latest/operate/rs/databases/configure/database-persistence), which can be pre-configured using a UI.
...
* On replicas, RDB supports [partial resynchronizations after restarts and failovers](https://redis.io/docs/latest/operate/oss_and_stack/management/replication#partial-resynchronizations-after-restarts-and-failovers).
