...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"sentinel-as-a-distributed-system","title":"Sentinel as a distributed system"},{"children":[{"id":"obtaining-sentinel","title":"Obtaining Sentinel"},{"id":"running-sentinel","title":"Running Sentinel"},{"id":"fundamental-things-to-know-about-sentinel-before-deploying","title":"Fundamental things to know about Sentinel before deploying"},{"id":"configuring-sentinel","title":"Configuring Sentinel"},{"id":"other-sentinel-options","title":"Other Sentinel options"},{"id":"example-sentinel-deployments","title":"Example Sentinel deployments"},{"id":"sentinel-docker-nat-and-possible-issues","title":"Sentinel, Docker, NAT, and possible issues"},{"id":"ip-addresses-and-dns-names","title":"IP Addresses and DNS names"}],"id":"sentinel-quick-start","title":"Sentinel quick start"},{"children":[{"id":"testing-the-failover","title":"Testing the failover"}],"id":"a-quick-tutorial","title":"A quick tutorial"},{"children":[{"id":"sentinel-commands","title":"Sentinel commands"},{"id":"reconfiguring-sentinel-at-runtime","title":"Reconfiguring Sentinel at Runtime"},{"id":"adding-or-removing-sentinels","title":"Adding or removing Sentinels"},{"id":"removing-the-old-master-or-unreachable-replicas","title":"Removing the old master or unreachable replicas"},{"id":"pubsub-messages","title":"Pub/Sub messages"},{"id":"handling-of--busy-state","title":"Handling of -BUSY state"},{"id":"sentinel-and-redis-authentication","title":"Sentinel and Redis authentication"}],"id":"sentinel-api","title":"Sentinel API"},{"children":[{"id":"redis-password-only-authentication","title":"Redis password-only authentication"},{"id":"sentinel-access-control-list-authentication","title":"Sentinel Access Control List authentication"},{"id":"sentinel-password-only-authentication","title":"Sentinel password-only authentication"},{"id":"sentinel-clients-implementation","title":"Sentinel clients implementation"}],"id":"redis-access-control-list-authentication","title":"Redis Access Control List authentication"},{"children":[{"id":"sdown-and-odown-failure-state","title":"SDOWN and ODOWN failure state"},{"id":"replica-selection-and-priority","title":"Replica selection and priority"}],"id":"more-advanced-concepts","title":"More advanced concepts"},{"children":[{"id":"quorum","title":"Quorum"},{"id":"configuration-epochs","title":"Configuration epochs"},{"id":"configuration-propagation","title":"Configuration propagation"},{"id":"consistency-under-partitions","title":"Consistency under partitions"},{"id":"tilt-mode","title":"TILT mode"}],"id":"algorithms-and-internals","title":"Algorithms and internals"}]}
...
Redis Sentinel provides high availability for Redis when not using [Redis Cluster](https://redis.io/docs/latest/operate/oss_and_stack/management/scaling). 
...
* **ACL** (`>= 6.2`) This command manages the Sentinel Access Control List. For more information refer to the [ACL](https://redis.io/docs/latest/operate/oss_and_stack/management/security/acl) documentation page and the [_Sentinel Access Control List authentication_](#sentinel-access-control-list-authentication).
...
Starting with Redis 6, user authentication and permission is managed with the [Access Control List (ACL)](https://redis.io/docs/latest/operate/oss_and_stack/management/security/acl).
...
Sentinel instances themselves can be secured by requiring clients to authenticate via the [`AUTH`](/commands/auth) command. Starting with Redis 6.2, the [Access Control List (ACL)](https://redis.io/docs/latest/operate/oss_and_stack/management/security/acl) is available, whereas previous versions (starting with Redis 5.0.1) support password-only authentication. 
...
Sentinel requires explicit client support, unless the system is configured to execute a script that performs a transparent redirection of all the requests to the new master instance (virtual IP or other similar systems). The topic of client libraries implementation is covered in the document [Sentinel clients guidelines](https://redis.io/docs/latest/develop/reference/sentinel-clients).
